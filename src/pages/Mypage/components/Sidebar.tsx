...
function Sidebar() {
  return (
    <section className="xl:pt-10 pt-4">
      ...
      <div className="md:w-full lg:w-[220px] xl:w-[280px] w-[70%] md:mx-0 mx-auto  md:h-[200px] md:gap-4 lg:gap-14 lg:h-[80vh] items-center rounded-xl flex flex-col bg-[#151228]">
        ...
        <ul className="flex md:flex-nowrap flex-wrap justify-between lg:flex-col lg:gap-5 gap-2">
          {navList.map(({ to, label, imageUrl }) => (
            <li key={to} className="mx-auto md:mx-0">
              <NavLink
                to={to}
                className={({ isActive }) =>
                  [
                    'flex lg:w-[220px] xl:w-[280px] w-[165px] border lg:border-none h-[48px] items-center gap-4 rounded-xl',
